...
import  com.Arsac_Hibernate.Jpa.Hibernate.demo.repository.CourseRepository;
import  com.Arsac_Hibernate.Jpa.Hibernate.demo.repository.EmployeeRepository;
import  com.Arsac_Hibernate.Jpa.Hibernate.demo.repository.StudentRepository;

@SpringBootApplication
public class JpaHibernateCompleteCodeApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(JpaHibernateCompleteCodeApplication.class, args);
	}
